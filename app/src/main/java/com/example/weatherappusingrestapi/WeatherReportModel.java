...
//    All these fields are present in the API so creating them here so that we can get the data of each particular field

    public WeatherReportModel(int id, String weather_state_name, String weather_state_abbr, String created, String wind_direction_compass, String applicable_date, float min_temp, float max_temp, float the_temp, float wind_speed, float wind_direction, int air_pressure, int humidity, float visibility, int predictability) {
        this.id = id;
